...
import MobileFullMenu from "./_components/MobileFullMenu";
...
export default function Demo1Layout({ children }) {
	...
	return (
		<div className="wrapper relative min-h-screen w-full bg-grey blurredBg">
			...
			<main className="page-content relative ml-0 bg-grey bg-opacity-95 lg:ml-20 backdrop-blur-lg backdrop-filter">
